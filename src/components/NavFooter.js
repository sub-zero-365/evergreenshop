        ...
        <motion.div>
            {
                !isNotShoppingCart && <div
                    className="fixed pt-4 md:hidden bottom-0 sm:py-4 z-10 w-full sm:w-fit sm:translate-y-1/2 sm:rounded-md sm:left-6 sm:bottom-1/2 min-h-[3rem] pb-4 bg-white shadow left-0"
                >
